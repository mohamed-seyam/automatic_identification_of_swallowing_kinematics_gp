...
class BolusSegmenterGUI(QObject):
    def __init__(self, algorithm: BolusSegmenter):
        super().__init__()
    ...
    def set_pharyngeal_data_dir(self, pharyngeal_data_dir):
        self.algorithm.pharyngeal_data_dir = pharyngeal_data_dir
    
    def set_checkpoint_path(self, checkpoint_path):
        self.algorithm.checkpoint_path = checkpoint_path
